...
const ALIASES = { 'ladyfinger':'cookies ladyfingers','ladyfingers':'cookies ladyfingers','savoiardi':'cookies ladyfingers','all purpose flour':'wheat flour all-purpose','all-purpose flour':'wheat flour all-purpose','plain flour':'wheat flour all-purpose','bread flour':'wheat flour bread','self raising flour':'wheat flour self-rising','mascarpone':'mascarpone','heavy cream':'cream heavy whipping','double cream':'cream heavy whipping','whole milk':'milk whole 3.25%','skim milk':'milk nonfat','2% milk':'milk reduced fat','butter':'butter without salt','cream cheese':'cream cheese','sour cream':'sour cream cultured','greek yogurt':'yogurt greek plain','greek yoghurt':'yogurt greek plain','parmesan':'cheese parmesan grated','mozzarella':'cheese mozzarella whole milk','ricotta':'cheese ricotta','white sugar':'sugars white granulated','granulated sugar':'sugars white granulated','caster sugar':'sugars white granulated','cane sugar':'sugars white granulated','brown sugar':'sugars brown packed','powdered sugar':'sugars powdered confectioners','icing sugar':'sugars powdered confectioners','honey':'honey','maple syrup':'syrups maple','egg yolk':'egg yolk raw fresh','egg yolks':'egg yolk raw fresh','egg white':'egg white raw fresh','egg whites':'egg white raw fresh','egg':'egg whole raw fresh','eggs':'egg whole raw fresh','cocoa powder':'cocoa powder unsweetened','vanilla extract':'vanilla extract','baking soda':'leavening baking soda','baking powder':'leavening baking powder','olive oil':'oil olive salad or cooking','vegetable oil':'oil vegetable salad or cooking','coconut oil':'oil coconut','sesame oil':'oil sesame salad or cooking','espresso':'beverages coffee brewed espresso','banana':'bananas raw','apple':'apples raw with skin','tomato':'tomatoes red ripe raw','onion':'onions raw','garlic clove':'garlic raw','garlic':'garlic raw','chicken breast':'chicken broilers fryers breast meat only raw','chicken thigh':'chicken broilers fryers thigh meat only raw','salmon':'fish salmon atlantic raw','tuna':'fish tuna light canned water','shrimp':'crustaceans shrimp mixed species raw','ground beef':'beef ground 80% lean','chicken broth':'soup stock chicken home-prepared','chicken stock':'soup stock chicken home-prepared','beef broth':'soup stock beef home-prepared','beef stock':'soup stock beef home-prepared','tomato paste':'tomato paste','coconut milk':'coconut milk','peanut butter':'peanut butter smooth style without salt','soy sauce':'soy sauce','oatmeal':'cereals oatmeal cooked','rolled oats':'oats rolled','water':'water tap drinking','warm water':'water tap drinking','salt':'salt table','kosher salt':'salt table','sea salt':'salt table','lemon juice':'lemon juice raw','lime juice':'lime juice raw','chia seed':'seeds chia dried','chia seeds':'seeds chia dried','almond':'nuts almonds','almonds':'nuts almonds','walnut':'nuts walnuts','walnuts':'nuts walnuts','dark chocolate':'chocolate dark 70-85%' };
...
function toGrams(qty, unit, itemName) {
  ...
  if (countableUnits.has(u)||u==='') {
    for (const [k,v] of Object.entries(COUNTABLE)) { if (name.includes(k)||k.includes(name.split(' ')[0])) return {grams:qty*v,qty,unit:u}; }
...
function estimateGrams(name,qty,unit) {
  ...
  for (const [k,v] of Object.entries(COUNTABLE)) { if (combined.includes(k)||nwu.includes(k)||n.includes(k)) return qty*v; }
