...
function toGrams(qty, unit, itemName) {
  ...
  if (f!=null) {
    ...
    if (volUnits.has(u)) {
      ...
      const isDryMatch=(rName,dry)=>rName.includes(dry)||dry.includes(rName)||(rName.split(' ').length===1&&dry.startsWith(rName));
